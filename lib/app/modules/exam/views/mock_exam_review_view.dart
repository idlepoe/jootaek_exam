...
class MockExamReviewView extends GetView<MockExamReviewController> {
  const MockExamReviewView({super.key});
                ...
                ...q.choices.map(
                  (c) => Padding(
                    ...
                    child: ExamChoiceCard(
                      question: q,
                      choice: c,
                      highlightCorrect: controller.highlightCorrect(c.no),
                      highlightSelected: controller.highlightSelected(c.no),
                      showPickLabel: controller.showPickLabel(c.no),
                    ),
                  ),
                ),
              ] else if (controller.loadError.value.isEmpty &&
                  controller.questions.isEmpty)
                const Text('해당 모의고사 이력을 찾을 수 없습니다.'),
